...
function doPost(e) {
  try {
    ...
    if (action == 'check_user') {
      ...
      var config = {
          version: "2.6.0",
          title: "TRD Happiness v2.6.0",
          message: "ปรับปรุงสิทธิ์การเข้าถึง QR Code และนำลิงก์ด่วนออกเพื่อความปลอดภัย",
          notifications: []
      };
...
function updateUserRoleStatus(ss, targetUserId, newRole, optionalScore) {
  var diag = { 
    ...
    scriptVersion: "v2.6.0 (Admin QR Restrict & Remove Magic Link)",
